...
namespace Engine.cgimin.engine.material.ibl
{
    class FullscreenIBL : BaseLighting
    {
        ...
        public void Draw(BaseObject3D object3d, int colorRoughnessBufferTexID, int normalTexID, int positionTexID, int metalnessTexID, int glowTexID, int iblSpecularCube, int iblIrradianceCube)
        {
