...
namespace Engine.cgimin.engine.postprocessing.blur
{
    ...
    public class BlurVerticalMaterial : BasePostprocessing
    {
        ...
        public BlurVerticalMaterial()
        {
            ...
            Program = ShaderCompiler.CreateShaderProgram("cgimin/engine/postprocessing/blur/BlurVertical_VS.glsl", "cgimin/engine/postprocessing/blur/BlurVertical_FS.glsl");
