...
{
    public class GUISlideGraphic : GUIElement
    {
        ...
        public GUISlideGraphic(Texture texture, int u1, int v1, int width, int height) : base()
        {
        ...
        public void SetSlideVlaue(float slide)
        {
            currentSlide = slide;
        }
        ...
        public override void Draw()
        {
            ...
            Matrix4 refMatric = intMatrix * Camera.GuiProjection;
