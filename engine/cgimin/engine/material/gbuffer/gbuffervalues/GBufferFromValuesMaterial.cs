...
namespace cgimin.engine.material.gbuffervalues
{
    public class GBufferFromValuesMaterial : BaseMaterial
    {
        ...
        public GBufferFromValuesMaterial()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram("cgimin/engine/material/gbuffer/gbuffervalues/GBufferFromValues_VS.glsl",
                                "cgimin/engine/material/gbuffer/gbuffervalues/GBufferFromValues_FS.glsl");
        ...
        public void Draw(BaseObject3D object3d, int normalTextureID, float roughness, float metalness, Vector3 color, float glow)
        {
        ...
        {
            Draw(object3d, settings.normalTexture, settings.roughness, settings.metalness, settings.color, settings.glow);
        }
