...
{
    public class GBufferFromTwoTexturesMaterial : BaseMaterial
    {
        ...
        public GBufferFromTwoTexturesMaterial()
        {
            // Shader-Programm wird aus den externen Files generiert...
            CreateShaderProgram("cgimin/engine/material/gbuffer/gbuffertwotextures/GBufferFromTwoTexturesLayout_VS.glsl",
                                "cgimin/engine/material/gbuffer/gbuffertwotextures/GBufferFromTwoTexturesLayout_FS.glsl");
        ...
        public void Draw(BaseObject3D object3d, int textureID, int normalTextureID)
        {
        ...
        {
            Draw(object3d, settings.colorTexture, settings.normalTexture);
        }

        public void DrawDirect(BaseObject3D object3d, int textureID, int normalTextureID)
        {
            PreDraw();
            Draw(object3d, textureID, normalTextureID);
            PostDraw();
        }
